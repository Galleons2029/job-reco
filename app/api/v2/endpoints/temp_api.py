    ...
    try:
        with QdrantClientManager.get_client_context() as qdrant_client:
            if resumes_request.is_school_user:
                collection = mongo_client.resumes.resumes_school_test
            else:
            ...
            if resumes_request.gender:
                match_dict["gender"] = resumes_request.gender
