# -*- coding: utf-8 -*-
# @Time    : 2024/11/18 15:42
# @Author  : Galleons
# @File    : fair_id_inject.py
...
# 读取CSV文件
df = pd.read_csv("/home/weyon2/DATA/table_data/jobs/2024-11-29-17-53-42_EXPORT_CSV_16607340_368_0.csv")
    ...
    with QdrantClientManager.get_client_context() as qdrant_client:
        try:
            ...
            for update in updates:
                ...
                fair_id_list = search_result[0].payload.get('fair_list', [])

                if fair_id not in fair_id_list:
                    fair_id_list.append(fair_id)

                    update_operations.append(
                        models.SetPayloadOperation(
                            set_payload=models.SetPayload(
                                payload={"fair_list": fair_id_list},
                                points=[publish_id]  # 直接使用点ID列表
                            )
                        )
                    )
