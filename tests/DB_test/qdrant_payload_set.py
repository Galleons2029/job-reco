...
# 读取CSV文件
df = pd.read_csv("/home/weyon2/DATA/table_data/jobs/2024-11-18-10-10-19_EXPORT_CSV_16382037_240_0.csv")
...
def batch_update_qdrant_payloads(
    collection_name: str,
